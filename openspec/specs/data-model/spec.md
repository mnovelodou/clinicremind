...
Defines the persistent relational schema for ClinicRemind: the clinics, users,
roles, doctors, patients, receptionist grants, and appointments that make up
the iteration-1 source of truth in Postgres, plus the Alembic migration that
installs it.
