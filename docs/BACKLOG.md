...
| D1 | Define & migrate all tables (clinics, users, clinic_members, doctors, doctor_receptionist_grants, patients, appointments) | Foundation | F1 | done | [openspec](../openspec/changes/d1-data-model/) |
